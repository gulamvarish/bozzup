	...
	<?php
		if(!$pmpro_confirm)
		{
			...
			<div class="<?php echo pmpro_get_element_class( 'pmpro_actionlinks' ); ?>">
				<a class="<?php echo pmpro_get_element_class( 'pmpro_btn pmpro_btn-submit pmpro_yeslink yeslink', 'pmpro_btn-submit' ); ?>" href="<?php echo pmpro_url("cancel", "?levelstocancel=" . esc_attr($_REQUEST['levelstocancel']) . "&confirm=true". "&usersubscription=". esc_attr($_REQUEST['usersubscription']))?>"><?php _e('Yes, cancel this membership', 'paid-memberships-pro' );?></a>
