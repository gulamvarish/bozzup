   ...
   <p class="<?php echo pmpro_get_element_class( 'pmpro_actions_nav' ); ?>">
	...
	<div class="col-sm-6 float-left invoice-right <?php echo pmpro_get_element_class( 'pmpro_invoice_details' ); ?>">
		...
		<?php } ?>
  	 	...
  	 	<a class="<?php echo pmpro_get_element_class( 'pmpro_a-print' ); ?> btn" href="javascript:window.print()"><?php _e('Print', 'paid-memberships-pro' );?></a>
...
<?php
	...
	?>
	<ul>
		<li><strong><?php _e('Account1', 'paid-memberships-pro' );?>:</strong> <?php echo esc_html( $current_user->display_name );?> (<?php echo esc_html( $current_user->user_email );?>)</li>
