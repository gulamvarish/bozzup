...
if ( ! class_exists( 'WPSC_Functions' ) ) :
  ...
  final class WPSC_Functions {
    ...
    function submit_ticket_thread($args){
      ...
      add_post_meta( $thread_id, 'order_status', $args['order_status'] );     
      ...
      $user =  isset($_SESSION['user_type']) ? $_SESSION['user_type'] : '';
      add_post_meta( $thread_id, 'user', $user );
    ...
    public function create_new_ticket($values){
      ...
      //add_ticket_meta($ticket_id, 'user', $_SESSION['user_type']);
      return $ticket_id;
    }
