  ...
  final class WPSC_Admin {
    ...
    public function loadScripts(){
      if(isset($_REQUEST['page']) && preg_match('/wpsc-/',$_REQUEST['page'])) :
        ...
        $localize_script_data = apply_filters( 'wpsc_admin_localize_script', array(
            ...
            'change_ticket_status' => __('Change Order Status','supportcandy'),
            'delete_tickets'       => __('Delete Orders','supportcandy'),
            'assign_agent'         => __('Assign Agent','supportcandy'),
            'change_ticket_status' => __('Change Order Status','supportcandy'),
            'edit_this_thread'     => __('Edit This Thread','supportcandy'),
            'close_ticket'         => __('Close Order','supportcandy'),
            'clone_ticket'         => __('Clone Order','supportcandy'),
            ...
            'restore_ticket'       => __('Restore Order','supportcandy'),  
            'restore_deleted_tickets' => __('Restore Deleted Orders','supportcandy'),
            'change_raised_by'     => __('Change Raised By','supportcandy'),
            'view_more' => __('View More','supportcandy'),
            'view_less' => __('View Less','supportcandy'),
            'delete_tickets_permanently' => __('Delete Orders Permanently','supportcandy'),
            'delete_ticket_permanently'  => __('Delete Order Permanently','supportcandy'),
            'create_thread_ticket'       => __('Create Order From Thread','supportcandy'),
            ...
            'extra_ticket_info'          => __('Order Info ','supportcandy'),
            'users_all_tickets'          => __('All Orders','supportcandy'),
            ...
            'change_ticket_fields'       => __('Change Order Fields','supportcandy'),
            'assign_agent'               => __('Assign Agent','supportcandy'),
            'delete_ticket'              => __('Delete Order','supportcandy')
          ));
    ...
    public function register_dashboard_menu(){
      ...
      add_menu_page( 
        ...
        __( 'Support Order','supportcandy'). " <span id='wpsc_ur_count' class='update-plugins count-{$unresolved_count}'><span class='theme-count'>" . number_format_i18n($unresolved_count) . "</span></span>",
        'wpsc_agent',
        'wpsc-orders',
        array($this,'tickets'),
      ...
      /*add_submenu_page(
        'wpsc-orders',
        __( 'Order List', 'supportcandy' ),
        __( 'Orders', 'supportcandy' ),
        'wpsc_agent',
        'wpsc-orders',
        array($this,'tickets')
      );*/
