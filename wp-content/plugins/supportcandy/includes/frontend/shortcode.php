...
<div class="bootstrap-iso">
  ...
  <div id="wpsc_tickets_container" class="row loginnewdesign" style="color:<?php echo $general_appearance['wpsc_text_color']?> !important; border-color:<?php echo $general_appearance['wpsc_action_bar_color']?> !important;"></div><?php
  ...
  <div class="bootstrap-iso">
    <div class="row">
      <div id="wpsc_popup" class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
        <div id="wpsc_popup_titles" class="row" style="padding:8px!important;background-color:<?php echo $wpsc_appearance_modal_window['wpsc_header_bg_color']?> !important;color:<?php echo $wpsc_appearance_modal_window['wpsc_header_text_color']?> !important;" >
          <!--popup label update, Change order status  -->
          <h3><?php _e('Change Order Status','supportcandy'); ?></h3>
