<?php 
/**
 * Plugin Name: SupportOrder
 * Plugin URI: example.com
 * Description: Easy & Powerful order support system for WordPress
 * Version: 500.2.0
 * Author: SupportOrder Team
...
if ( ! class_exists( 'Support_Candy' ) ) :
  ...
  final class Support_Candy {
    ...
    function define_constants() {
        $this->define('WPSC_STORE_URL', 'https://example.com');
